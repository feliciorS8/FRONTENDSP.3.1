...
def submit_reservasi():
    ...
    pesan = f"""Halo, saya ingin reservasi:

Nama: {nama_pasien}
Poli: {request.form.get('poli_name', 'Tidak diketahui')}
Dokter: {dokter['nama_dokter'] if dokter else 'Tidak diketahui'}
Tanggal: {tanggal}
Keluhan: {keluhan}

Terima kasih!"""
    
    # Nomor WhatsApp RS (ganti dengan nomor asli)
    wa_number = dokter['no_wa'] if dokter and dokter['no_wa'] else '6281234567890'
    wa_url = f"https://wa.me/{wa_number}?text={pesan}"
